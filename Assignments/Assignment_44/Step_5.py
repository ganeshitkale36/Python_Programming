...
def MarvellousAdvertise(Datpath):
    ...
    #--------------------------------------------------------------------
    # Step  9 : Compare the Actual and predcited sales
    #----------------------------------------------------------------------
    print(Border)
    print("Step  9 : Display the Actual and predcited sales")
    print(Border)

    result = pd.DataFrame({
        "Acutal_sales":Y_test.values,
        "Predcited_sales":Y_pred
     })
    ...
    #----------------------------------------------------------------------
    print(Border)
    print("Step 10 : plot the Actual and predicted values")
    print(Border)

    plt.figure(figsize=(8,5))
    plt.scatter(Y_test,Y_pred)
    plt.title("Actual_values vs Predcited_values")
    plt.grid(True)
    plt.show()
